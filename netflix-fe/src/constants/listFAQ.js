...
const FAQ_TITLE_EN = "Frequently Asked Question"
...
const LIST_FAQ_ID = [
    ...
    },
    {
        ...
        desc: "Tonton di mana pun, kapan pun. Masuk ke akun Netflix-mu untuk menonton langsung di netflix.com dari komputer pribadi atau di perangkat yang terhubung ke Internet dan mendukung aplikasi Netflix, termasuk smart TV, smartphone, tablet, pemutar media streaming, dan konsol game. \\n\\nKamu juga bisa men- download acara favoritmu dengan aplikasi iOS atau Android.Gunakan download untuk menonton saat kamu di perjalanan dan tidak punya koneksi Internet.Bawa Netflix ke mana saja.",
        isOpen: false
    },
    {
        title: "Bagaimana cara membatalkan?",
    ...
    {
        title: "Apa yang bisa saya tonton di Netflix?",
    ...
    {
        title: "Apakah Netflix cocok untuk anak-anak?",
        desc: "Pengalaman Netflix Anak disertakan dalam keanggotaan agar kamu punya kontrol orang tua saat anak-anak menikmati acara TV dan film untuk keluarga di rumah. \\n\\nProfil anak dilengkapi kontrol orang tua yang dilindungi PIN sehingga kamu bisa membatasi rating usia konten yang bisa ditonton anak dan memblokir judul tertentu yang tidak boleh ditonton anak- anak.",
        isOpen: false
    }
]
...
const LIST_FAQ_EN = [
    ...
    {
        title: "What can I watch from Netflix?",
